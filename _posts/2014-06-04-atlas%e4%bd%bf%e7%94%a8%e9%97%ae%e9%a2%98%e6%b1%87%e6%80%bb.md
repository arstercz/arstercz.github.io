...
见<a href="https://github.com/arstercz/Atlas_auto_setline">https://github.com/chenzhe07/Atlas_auto_setline</a>
<pre>
# atlas auto set line.
...
```
ay  3 09:55:31 cz kernel: Out of memory: Kill process 45330 (mysql-proxy) score 1 or sacrifice child
ay  3 09:55:31 cz kernel: Killed process 45331, UID 0, (mysql-proxy) total-vm:4917192kB, anon-rss:177720kB, file-rss:40kB
ay  3 09:55:31 cz kernel: mysql-proxy: page allocation failure. order:0, mode:0x201da
ay  3 09:55:31 cz kernel: Pid: 45331, comm: mysql-proxy Not tainted 2.6.32-431.5.1.el6.x86_64 #1
ay  3 09:55:31 cz kernel: Call Trace:
ay  3 09:55:31 cz kernel: [<ffffffff8112f9d7>] ? __alloc_pages_nodemask+0x757/0x8d0
ay  3 09:55:31 cz kernel: [<ffffffff81167a8a>] ? alloc_pages_current+0xaa/0x110
ay  3 09:55:31 cz kernel: [<ffffffff8111fd47>] ? __page_cache_alloc+0x87/0x90
ay  3 09:55:31 cz kernel: [<ffffffff8111f72e>] ? find_get_page+0x1e/0xa0
ay  3 09:55:31 cz kernel: [<ffffffff81120ce7>] ? filemap_fault+0x1a7/0x500
ay  3 09:55:31 cz kernel: [<ffffffff8114a074>] ? __do_fault+0x54/0x530
ay  3 09:55:31 cz kernel: [<ffffffff8114a647>] ? handle_pte_fault+0xf7/0xb00
ay  3 09:55:31 cz kernel: [<ffffffff81527c20>] ? thread_return+0x4e/0x76e
ay  3 09:55:31 cz kernel: [<ffffffff8109f23b>] ? __remove_hrtimer+0x3b/0xb0
ay  3 09:55:31 cz kernel: [<ffffffff8109f7f1>] ? lock_hrtimer_base+0x31/0x60
ay  3 09:55:31 cz kernel: [<ffffffff810a047f>] ? hrtimer_try_to_cancel+0x3f/0xd0
ay  3 09:55:31 cz kernel: [<ffffffff8114b27a>] ? handle_mm_fault+0x22a/0x300
ay  3 09:55:31 cz kernel: [<ffffffff8104a8d8>] ? __do_page_fault+0x138/0x480
ay  3 09:55:31 cz kernel: [<ffffffff811d174e>] ? ep_poll+0x12e/0x330
ay  3 09:55:31 cz kernel: [<ffffffff81065df0>] ? default_wake_function+0x0/0x20
ay  3 09:55:31 cz kernel: [<ffffffff8152d76e>] ? do_page_fault+0x3e/0xa0
ay  3 09:55:31 cz kernel: [<ffffffff8152ab25>] ? page_fault+0x25/0x30
```
