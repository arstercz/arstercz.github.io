...
(3)该工具早期的版本支持sql重放等工具, 对InnoDB的预热需求是一个不错的手段, 详见 <a href="http://zhechen.me/keep-your-slave-warm/"><font color="green">http://zhechen.me/keep-your-slave-warm/</font></a>, 也支持统计分析tcpdump监听memcached生成的日志文件。
<!--more-->
