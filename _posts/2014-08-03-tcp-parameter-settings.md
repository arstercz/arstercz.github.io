...
tags:
  - TCP
---
```sysctl -w net.core.rmem_max=8388608</pre>
# maximum receive size of buffers used by sockets
```sysctl -w net.core.wmem_max=8388608</pre>
# maximum socket send buffer size
```sysctl -w net.core.rmem_default=65536</pre>
# default setting in bytes of the socket receive buffer
```sysctl -w net.core.wmem_default=65536</pre>
# default setting in bytes of the socket send buffer
<!--more-->

```sysctl -w net.ipv4.tcp_rmem='4096 87380 8388608'</pre>
...
```sysctl -w net.ipv4.tcp_wmem='4096 65536 8388608'</pre>
...
```sysctl -w net.ipv4.tcp_mem='8388608 8388608 8388608'</pre>
