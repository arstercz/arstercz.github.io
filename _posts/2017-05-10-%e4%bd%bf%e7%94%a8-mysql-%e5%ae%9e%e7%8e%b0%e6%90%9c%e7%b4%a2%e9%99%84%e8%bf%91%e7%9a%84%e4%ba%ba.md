...
在 MySQL `5.5/5.7` 版本中则可以直接使用 [ST_Distance_Sphere](https://dev.mysql.com/doc/refman/5.7/en/spatial-convenience-functions.html#function_st-distance-sphere) 函数计算两个地理位置的距离, 默认情况下, `radius` 参数为地球的极半径 6370986 米, 返回的结果单位为`米`, 如下所示
```sql
