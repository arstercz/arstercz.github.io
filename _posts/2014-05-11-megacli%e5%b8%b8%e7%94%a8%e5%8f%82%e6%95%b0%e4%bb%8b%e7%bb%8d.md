...
1. 可以替换并重新 rebuild
MegaCli -PdReplaceMissing -PhysDrv[32:1]] -array0 -row0 -a0 # 如果有多个raid, 可以使用 -PDGetMissing 选项获取磁盘的具体位置   
MegaCli -PDRbld -Start -PhysDrv[32:1] -a0
MegaCli -PDRbld -ShowProg -PhysDrv[32:1] -aALL

MegaCli -PDRbld -ProgDsply -PhysDrv[32:1] -a0  # 查看指定磁盘的 rebuild 进度
...
# 该命令可以获取磁盘具体所在的 disk group 信息, 如果想重新 rebbuild 可以使用命令:
